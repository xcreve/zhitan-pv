...
export const timeTypeField: PvSearchField = {
  prop: 'timeType',
  label: '时间类型',
  type: 'select',
  options: [
...
export const timeTypeEnumField: PvSearchField = {
  prop: 'timeTypeEnum',
  label: '时间类型',
  type: 'select',
...
export const dateField: PvSearchField = { prop: 'queryTime', label: '查询日期', type: 'date' }
export const dataTimeField: PvSearchField = { prop: 'dataTime', label: '统计日期', type: 'date' }
export const monthField: PvSearchField = { prop: 'dateTime', label: '统计月份', type: 'month' }

export const stationSearchFields: PvSearchField[] = [
  { prop: 'code', label: '编号' },
  { prop: 'name', label: '名称' }
]

export const deviceSearchFields: PvSearchField[] = [
...
export const alarmSearchFields: PvSearchField[] = [
...
export const stationColumns: PvTableColumn[] = [
...
export const deviceColumns: PvTableColumn[] = [
...
export const alarmColumns: PvTableColumn[] = [
  { prop: 'powerStationName', label: '电站', minWidth: 150 },
...
export const generationColumns: PvTableColumn[] = [
...
export const compareColumns: PvTableColumn[] = [
...
export const peakColumns: PvTableColumn[] = [
...
export const inspectionColumns: PvTableColumn[] = [
  { prop: 'powerStationName', label: '电站', minWidth: 150 },
  { prop: 'deviceCode', label: '设备编号', minWidth: 120 },
  { prop: 'deviceName', label: '设备名称', minWidth: 140 },
...
export const sparePartsColumns: PvTableColumn[] = [
  { prop: 'code', label: '编号', minWidth: 120 },
...
export const deviceTypeColumns: PvTableColumn[] = [
...
export const electricitySettingColumns: PvTableColumn[] = [
...
export const qualitySearchFields: PvSearchField[] = [
