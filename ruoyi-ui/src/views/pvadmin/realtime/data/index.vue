...
import DataTablePage from '@/components/pvadmin/DataTablePage.vue'
import type { PvSearchField, PvTableColumn } from '@/api/pvadmin/types/common'
import { listRealTimeData, type RealTimeDataRecord } from '@/api/pvadmin/realtime/data'

const columns: PvTableColumn<RealTimeDataRecord>[] = [
...
<template>
  <DataTablePage
    ...
    :list-api="listRealTimeData"
    :columns="columns"
    :search-fields="searchFields"
    :default-params="{ powerStationId: '-1' }"
    permission="pvadmin:realtime:data"
